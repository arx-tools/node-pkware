...
import { clamp, evenAndRemainder, getLowestNBits, nBitsOfOnes, repeat, toHex } from '@src/functions.js'
...
export class Implode {
  ...
  private dictionarySizeMask: number = -1
  private streamEnded: boolean = false
  private readonly distCodes: number[] = structuredClone(DistCode)
  private readonly distBits: number[] = structuredClone(DistBits)
  private startIndex: number = 0
  private handledFirstTwoBytes: boolean = false
  private outBits: number = 0
  private nChBits: number[] = repeat(0, 0x3_06)
  private nChCodes: number[] = repeat(0, 0x3_06)

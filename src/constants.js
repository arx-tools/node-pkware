const BINARY_COMPRESSION = 0
const ASCII_COMPRESSION = 1

const ERROR_INVALID_DICTIONARY_SIZE = 'Invalid dictionary size'
const ERROR_INVALID_COMPRESSION_TYPE = 'Invalid compression type'
const ERROR_INVALID_DATA = 'Invalid data'
const ERROR_ABORTED = 'Aborted'

const DICTIONARY_SIZE1 = 0x0400
const DICTIONARY_SIZE2 = 0x0800
const DICTIONARY_SIZE3 = 0x1000
